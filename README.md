...
import etmiş. Fakat ben kendi yazdığım yani news.py dosyasını da 
main.py'nin aynı satırını import kodu yazmak istediğim zaman
push esnasında 'rejected' hatası ile karşılaştım bir an panikledim,
ancak çalışmayı 'git pull' komutu ile bilgisayarıma çektikten sonra
kodun içindeki '<<<<', '====', '>>>>' işaretlerini görünce Git'in aslında
